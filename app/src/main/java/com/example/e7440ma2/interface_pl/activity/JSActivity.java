...
import com.example.e7440ma2.interface_pl.AudioPlayer;
import com.example.e7440ma2.interface_pl.AudioRecorder;
import com.example.e7440ma2.interface_pl.JSVideoView;
import com.example.e7440ma2.interface_pl.R;
...
import com.example.e7440ma2.interface_pl.drone.JSDrone;
...
public class JSActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        {
            mConnectionProgressDialog = new ProgressDialog(this, R.style.Theme_AppCompat_DayNight_Dialog_Alert);
    ...
    private void initIHM() {
        ...
        findViewById(R.id.downloadBt).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                mDownloadProgressDialog = new ProgressDialog(JSActivity.this, R.style.Theme_AppCompat_DayNight_Dialog_Alert);
